...
import { parseToolCall, buildToolSystemPrompt, extractJsonObjects } from '../mcp-parser';
...
describe('parseToolCall', () => {
  ...
  it('extracts tool call from inside a JSON array wrapper', () => {
    // Some models wrap the call in an array — Pattern 1 finds the inner object
...
describe('extractJsonObjects', () => {
  ...
  it('skips malformed objects and finds valid ones after them', () => {
    // Truly separate: bad text before a valid JSON object
